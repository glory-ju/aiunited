...
df = pd.read_csv('store_info.csv', encoding='euc-kr')
id_list = []
data_frame = []
...
for idx in range(len(df['key_words'])):
    ...
    try:
        ...
        store_addr = json_load['result']['place']['list'][0]['address']
    ...
    data = '[{"operationName":"getVisitorReviews","variables":{"input":{"businessId":"12024487","businessType":"restaurant","item":"0","bookingBusinessId":null,"page":1,"display":10,"isPhotoUsed":false,"includeContent":true,"getAuthorInfo":true},"id":"12024487"},"query":"query getVisitorReviews($input: VisitorReviewsInput) {\\n  visitorReviews(input: $input) {\\n    items {\\n      id\\n      rating\\n      author {\\n        id\\n        nickname\\n        from\\n        imageUrl\\n        objectId\\n        url\\n        review {\\n          totalCount\\n          imageCount\\n          avgRating\\n          __typename\\n        }\\n        theme {\\n          totalCount\\n          __typename\\n        }\\n        __typename\\n      }\\n      body\\n      thumbnail\\n      media {\\n        type\\n        thumbnail\\n        __typename\\n      }\\n      tags\\n      status\\n      visitCount\\n      viewCount\\n      visited\\n      created\\n      reply {\\n        editUrl\\n        body\\n        editedBy\\n        created\\n        replyTitle\\n        __typename\\n      }\\n      originType\\n      item {\\n        name\\n        code\\n        options\\n        __typename\\n      }\\n      language\\n      highlightOffsets\\n      apolloCacheId\\n      translatedText\\n      businessName\\n      showBookingItemName\\n      showBookingItemOptions\\n      bookingItemName\\n      bookingItemOptions\\n      votedKeywords {\\n        code\\n        displayName\\n        __typename\\n      }\\n      userIdno\\n      isFollowing\\n      followerCount\\n      followRequested\\n      loginIdno\\n      __typename\\n    }\\n    starDistribution {\\n      score\\n      count\\n      __typename\\n    }\\n    hideProductSelectBox\\n    total\\n    __typename\\n  }\\n}\\n"}]'
    ...
    businessid = id_list[idx]
    page = total_review // 10
...
# print(slicing[0]['data']['visitorReviews']['items'])
...
# date_list = response.text.split('"created":')[1].split(',"replyTitle"')[0].replace('"', '')
# score_list = response.text.split('"rating":')[1].split(',"author"')[0]
# review_list = response.text.split('"body":')[1].split(',"thumbnail":')[0].replace('"', '')
#
# print([date_list, score_list, review_list
#
# store_addr == df['store_addr'][idx]:
#         store_id = json_load['result']['place']['list'][0]['id']
#         print(store_id)])